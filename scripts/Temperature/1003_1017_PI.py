...
model = "e007_2_hpc-bw_e5w2.3_PI_t159l31.1d"
path2 = "/output_raw/"
...
nco = Dataset("/esd/esd01/docs/hsharma/data_small/data/1003_1017_PI.nc",'w', format="NETCDF4_CLASSIC")
...
Ta = np.zeros((12,lat, lon), dtype=np.float64)
MAT = np.zeros((12,lat,lon), dtype=np.float64)
