...
# and sediment thickness for LGM
#############################################################################
...
nco = Dataset("/esd/esd01/docs/hsharma/data_small/data/1003_1017_LGM.nc",'w', format="NETCDF4_CLASSIC")
...
Ta = np.zeros((16,lat, lon), dtype=np.float64)
MAT = np.zeros((16,lat,lon), dtype=np.float64)
