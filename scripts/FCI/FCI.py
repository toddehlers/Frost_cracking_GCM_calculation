...
path = "/esd/esd01/docs/hsharma/data_small/FCI_data/FCI/"
file1 = "Integrated_FCI_PI.nc"
file2 = "Integrated_FCI_MH.nc"
file3 = "Integrated_FCI_LGM.nc"
file4 = "Integrated_FCI_PLIO.nc"
...
nco = Dataset("/esd/esd01/docs/hsharma/data_small/FCI_data/FCI/FCI.nc",'w', format="NETCDF4_CLASSIC")
...
print('Globally summed up FCI for PI: ', np.sum(np.where(Ci_PI<0,0,Ci_PI)))
print('Globally summed up FCI for MH: ', np.sum(np.where(Ci_MH<0,0,Ci_MH)))
print('Globally summed up FCI for LGM: ', np.sum(np.where(Ci_LGM<0,0,Ci_LGM)))
print('Globally summed up FCI for PLIO: ', np.sum(np.where(Ci_Plio<0,0,Ci_Plio)))
