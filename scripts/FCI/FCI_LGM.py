####################################################################################################
#       File to calculate Frost Cracking Intensity [DegC/m] (as a function of temperature gradient)
#       for Last Glacial Maximum (~21 ka)
#       Data Source:
...
path = "/esd/esd01/docs/hsharma/data_small/data/Temperature/"	# Path to folder containing Temperature data (with MAT, Annual Temperature Variation (Ta))         
file1 = "1003_1017_LGM.nc"             				# File containing MAT and Ta for PI simulation
data1 = path + file1
...
from frost_cracking_intensity import cracking_intensity		# Calling the "cracking_intensity" function, which calculates the Annual Integrated FCI
...
nco = Dataset("/esd/esd01/docs/hsharma/data_small/data/Integrated_FCI_%s.nc" % (S,),'w', format="NETCDF4_CLASSIC")
