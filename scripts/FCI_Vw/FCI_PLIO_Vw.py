...
path1 = "/esd/esd01/docs/hsharma/data_small/data/Temperature/"	# Path to folder containing Temperature data (with MAT, Annual Temperature Variation (Ta))
file1 = "1003_1017_Plio.nc"            				# File containing MAT and Ta for Pliocene simulation
path2 = "/esd/esd01/share/arc/soil_thickness/"			# Path to folder containing soil thickness (Hs)
