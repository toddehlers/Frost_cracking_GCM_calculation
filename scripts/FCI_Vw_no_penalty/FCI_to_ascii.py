...
Ci_PD = nc.variables['Ci'][0,:,:]
Ci_PI = nc.variables['Ci'][1,:,:]
Ci_MH = nc.variables['Ci'][2,:,:]
Ci_LGM = nc.variables['Ci'][3,:,:]
Ci_PLIO = nc.variables['Ci'][4,:,:]

nlat,nlon = np.shape(Ci_PI)


Ci = np.zeros((5,nlat,nlon), dtype = np.float32)
