...
#	for Last Glacial Maximum, LGM (~21 ka)
#	Data Source:
#	MAT, Ta (Temperature) = ECHAM5 simulation (Mutz et al., 2018)
...
file1 = "1003_1017_LGM.nc"				# File containing MAT and Ta for LGM simulation
...
S = "LGM"						# Defining the time-slice for the current file
...
nc_SLM = Dataset('/esd/esd02/data/climate_models/echam/echam_output/ESD/e009_hpc-bw_e5w2.3_LGM_t159l31.1d/src/input/T159_LGM/T159_jan_surf_lgm_veg.nc')
SLM = nc_SLM.variables['SLM'][:,:]
GLAC = nc_SLM.variables['GLAC'][:,:]
...
########################################################################
# Write out data to a new netCDF file for the current time slice (LGM)
########################################################################
