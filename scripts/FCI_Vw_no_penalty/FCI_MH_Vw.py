...
#	for Mid-Holocene (~6 ka)
#	Data Source:
#	MAT, Ta (Temperature) = ECHAM5 simulation (S. Mutz et al., 2017)
...
file1 = "1003_1017_MH.nc"            			# File containing MAT and Ta for MH simulation
...
S = "MH"						# Defining the time-slice for the current file
...
nc_SLM = Dataset('/esd/esd02/data/climate_models/echam/echam_output/ESD/e008_hpc-bw_e5w2.3_MH_t159l31.1d/src/input/T159_MH/T159_jan_surf_MH_2.nc')
...
#################################################################################
# Write out data to a new netCDF file for the current time slice (Mid-Holocene)
#################################################################################
